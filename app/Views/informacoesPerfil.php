...
<div class="container-fluid">
    ...
    <form method="POST" action="<?php echo url_to('cadastrarInformacoes') ?>">
        <input type="hidden" id="id_usuario" name="id_usuario" value="<?php esc('id_usuario') ?>">
        <div class="row">
            ...
            <div class="col-5">
                ...
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="fotoPerfil" placeholder="Selecione uma foto de perfil" name="fotoPerfil" accept="image/*">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-10 offset-1">
                ...
                <div class="input-group mb-3">
                    <textarea class="form-control" id="descrição" rows="3" placeholder="Breve descrição sobre seu trabalho" name="descricao"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-3 offset-1">
                ...
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="fotoTrabalho1" placeholder="Selecione uma foto de seu trabalho" name="fotoTrabalho1" accept="image/*">
                </div>
            </div>
            <div class="col-4">
                <label for="fotoTrabalho" class="form-label">Selecione uma foto de seu trabalho:</label>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="fotoTrabalho2" placeholder="Selecione uma foto de seu trabalho" name="fotoTrabalho2" accept="image/*">
                </div>
            </div>
            <div class="col-3">
                <label for="fotoTrabalho" class="form-label">Selecione uma foto de seu trabalho:</label>
                <div class="input-group mb-3">
                    <input type="file" class="form-control" id="fotoTrabalho3" placeholder="Selecione uma foto de seu trabalho" name="fotoTrabalho3" accept="image/*">
                </div>
            </div>
        </div>
